...
const Home = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.8 }, // Trigger when 80% of a project is visible
    );
  ...
  return (
    ...
    >
      ...
      <main
        ...
        className="page-wrapper flex lg:flex-col flex-row lg:overflow-y-auto overflow-x-auto h-full lg:w-[40%] w-[95%] no-scrollbar items-center lg:gap-0 gap-5 lg:ps-0 ps-2"
      >
        {projects.map((project, index) => (
          <div
            ...
            className={`flex-shrink-0 lg:flex-shrink lg:w-full w-[90%] flex flex-col items-center justify-center relative rounded-xl lg:p-5 lg:mb-10 mt-5 ${
              index === 0 && 'lg:mt-[22%]'
            }`}
          >
            <Link
      ...
      <div className="absolute  items-center justify-between  z-50 lg:block hidden ">
        <motion.div
        ...
        >
          ...
          <span className="w-3/4 2xl:text-base text-sm">
      ...
      <div className="absolute  items-center justify-center  z-50 lg:hidden block ">
        <motion.div
          key={projectDetails.name}
          initial={{ y: 20, opacity: 0 }} // Start from below with zero opacity
          animate={{ y: 0, opacity: 1 }} // Move up to its original position with full opacity
      ...
      <div className="w-[95%] flex items-center justify-between fixed z-50 ">
        ...
        <span className="fixed right-[3%] bottom-[4%] lg:top-[35%] text-[#575757]  2xl:text-base text-sm uppercase font-medium 2xl:leading-none leading-none not-italic ">
