...
export default function Rockzfx() {
  return (
    <SlideFromRight>
      <div
            ...
            <div className="col-span-12 lg:col-span-3  items-center flex justify-center h-full w-full lg:ps-10">
              <div className=" items-start flex justify-center  w-[80%]  flex-col lg:ps-5  gap-11">
                <div className="text-6xl font-semibold">
                  <AnimatedText2 text="Rockzfx"></AnimatedText2>
                </div>
                ...
                <div className="items-start flex   w-full  gap-5 justify-center">
                  <span className="text-3xl font-medium mr-10">
                    Tool’s Used
                  </span>
              ...
              <div className="flex items-start  ps-3 2xl:w-[80%] w-full flex-col">
                <div className="flex flex-col">
                  ...
                  <span className="text-2xl my-3">
                    ...
                    well but it was not something I enjoyed doing all of the
                    time. My time was owned and I wanted to own my time.I found
                    trading at 24 when a friend introduced hyper scalping to me.
                    We used indicators to trade the 1 minute timeframe and would
                    on average catch 3- 10 pips at a time. The adrenaline rush
                    was unex plainable. But it eventually led to blown accounts
                    due to greed.
                  </span>
                </div>
                <div className="flex flex-col">
