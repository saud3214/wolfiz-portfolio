    ...
    <SlideFromRight>
      ...
      >
          ...
          <div className=" grid grid-cols-12 items-start justify-center  py-10  w-full ">
            <div className="col-span-12 lg:col-span-6  items-center flex justify-center h-full w-full  text-white">
              <div className=" items-start flex justify-center  w-[80%]  flex-col lg:ps-5  gap-11">
                ...
                <span className="text-5xl font-medium  text-pg">
                  Confidence
                </span>
        ...
        <div className=" w-full  items-center  flex  bg-pg2 bg-center bg-cover ">
          <div className=" grid grid-cols-12 items-center justify-center  w-full  ">
            <div
             ...
             "
            >
              <div className="w-full flex flex-col text-5xl font-medium text-pgc2">
              ...
              <div className="flex items-center justify-between w-11/12 ">
                <div className="flex  lg:w-1/2 text-xl xl:p-12 ">
                  <span>
              ...
              <div className="flex items-center justify-between w-11/12  h-full pb-10">
                <div className="border border-dashed border-pg p-10 flex  flex-col items-center justify-center   bg-white/30 backdrop-blur-sm w-[45%] h-full rounded-3xl gap-5">
        ...
        <div className=" w-full  items-center  flex   ">
          <div className=" grid grid-cols-12 items-center justify-center  w-full  ">
            <div className="col-span-12   items-center flex  flex-col justify-center h-full w-full pt-10 ">
              <div className="w-full flex flex-col text-5xl font-medium text-pgc2">
        ...
        <div className="   w-full  items-center  flex flex-col   ">
          <div className=" grid grid-cols-12 items-start justify-center  py-10 w-full    ">
            <div className="col-span-12    flex flex-col items-center justify-start h-full w-full pt-10 mt-10">
              <div className="w-full flex flex-col text-5xl font-medium text-pgc2 py-10">
            ...
            <div className="flex flex-col col-span-12 items-center">
              <div className="flex  items-center   flex-col  w-full mt-10">
                ...
                <div className="flex w-full items-center justify-center px-20 pt-10">
                  <div className="flex  items-center  w-[45%] mb-3  relative  ">
                    <Image
              ...
              <div className="bg-pg flex w-full  py-10 items-center">
                <div className="flex  items-center  mb-3   relative w-1/2  ">
                  <Image
                    className="  relativepos "
                    src="/pg/laptop2.png"
                    alt="Background 1"
                ...
                <div className="flex  items-center   mb-3  relative w-1/4    ">
                  <Image
                    className="  relativepos "
                    src="/pg/iphone.png"
                    alt="Background 1"
