  ...
  return (
    <div className="  h-full w-full flex-col items-center p-6 ">
      <div className="h-full w-full  ">
        ...
        >
          <SwiperSlide className=" border border-red-400 slideclas bg-lime-200  ">
            Slide 1
          </SwiperSlide>
          <SwiperSlide className=" border border-red-400 slideclas  bg-green-200">
            Slide 2
          </SwiperSlide>
          <SwiperSlide className=" border border-red-400 slideclas bg-pink-200">
            Slide 3
          </SwiperSlide>
        </Swiper>
      </div>
