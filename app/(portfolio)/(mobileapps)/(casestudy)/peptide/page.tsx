        ...
        <div className="  w-full  items-center justify-center flex   ">
          <div className=" grid grid-cols-12 items-center justify-center   w-full  max-w-[1920px] ">
            <div className="flex  col-span-12 items-center justify-center flex-col w-full  ">
              ...
              <div className="grid grid-cols-12 items-center justify-center w-10/12 py-10 mt-10 gap-10">
                <div className="flex flex-col col-span-12  items-start justify-center  ">
                  ...
                  <span className=" text-2xl  mt-2  2xl:pe-10 2xl:pb-10">
                    Welcome to Peptide Calculator! Our user-friendly guide will
                    walk you through the seamless process of harnessing the
                    power of peptide dosage calculations. Whether you’re a
                    seasoned researcher, a healthcare professional, or simply
                    curious about peptides, our step-by-step instructions will
                    ensure you make the most of our platform. Discover precise
                    dosage insights and unlock the potential of your peptide
                    experiments effortlessly with the Peptide Calculator.
                  </span>
                </div>
                <div className="col-span-6 flex items-center justify-center ">
              ...
              <div className="grid grid-cols-12 items-center justify-center w-10/12 py-10 2xl:mt-10 gap-10">
                <div className="flex flex-col col-span-12  items-center justify-center  text-center ">
                  ...
                  <span className=" text-2xl  mt-2  2xl:pe-10 2xl:pb-10 2xl:w-9/12">
                    ...
                    research, healthcare, and experimental science but present
                    several challenges:
                  </span>
                </div>
              </div>
              <div className="w-full  flex flex-col items-center justify-center  bg-[#ECFBFD] p-10 my-10 h-[100vh] relative">
                ...
                <div className="flex  items-center  absolute  w-[15%]  left-[20%]  top-[19%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[15%]  left-[20%]  bottom-[18%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[15%]  right-[25%]  top-[13%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[15%]  right-[20%]  bottom-[18%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[25%]  left-[12%]  top-[41%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[25%]  right-[12%]  top-[41%]   ">
                  <Image
                    className=" relativepos "
              ...
              <div className="grid grid-cols-12 items-center justify-center w-10/12 py-10  gap-10">
                <div className="flex flex-col col-span-12  items-center justify-center  text-center ">
                  ...
                  <span className=" 2xl:text-2xl  text-xl mt-2  2xl:pe-10 2xl:pb-10 2xl:w-9/12">
                    <span className="text-lime-600">Peptide Calculator </span>
                    ...
                    efficiency for researchers, healthcare professionals, and
                    curious individuals.
                  </span>
                </div>
              </div>

              <div className="w-full  flex  items-center justify-center  bg-gradient-to-r from-[#62B26B] to-[#18A0B7] p-20 my-10  relative ">
                ...
                <div className="flex  items-center  absolute  w-[20%]  left-[23%]  top-[13%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[35%]  left-[12%]  top-[37%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[27%]  left-[18%]  bottom-[27%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[35%]  left-[17%]  bottom-[15%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[23%]  right-[20%]  top-[13%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[27%]  right-[17%]  top-[27%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[34%]  right-[12%]  bottom-[38%]   ">
                  <Image
                    className=" relativepos "
                ...
                <div className="flex  items-center  absolute  w-[32%]  right-[14%]  bottom-[18%]   ">
                  <Image
                    className=" relativepos "
              ...
              <div className="w-11/12 items-center justify-between flex flex-col h-[100vh] bg-white p-10">
                <div className="w-full flex items-center justify-center 2xl:gap-20 gap-10">
                ...
                <div className="w-full flex items-center justify-between gap-10">
                  <span className="text-4xl font-medium ">
                    ABCDEFGHIJKLMNOPQRSTUVWXYS<br></br>
                ...
                <div className=" grid grid-cols-10 items-center justify-center gap-5 w-full h-32">
