        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="relative z-20 w-[95%] h-screen flex flex-col justify-between py-[1%]">
                ...
                <div className="max-w-6xl mx-auto 2xl:gap-12 xl:gap-10 gap-5 flex flex-col  no-image-zone">
                  ...
                  >
                    ...
                    <div className="flex w-full justify-between">
                      ...
                      <button className="group flex text-sm items-center gap-2 px-4 py-2 rounded-xl border border-neutral-800 transition-colors h-fit">
                        VISIT
              ...
              {/* Decorative Image */}
              <div className="fixed bottom-[4%] right-[3%]  w-[18rem] h-[18rem] rounded-full overflow-hidden no-image-zone">
                <Image
